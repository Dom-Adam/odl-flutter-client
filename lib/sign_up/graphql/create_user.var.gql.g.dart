...
class _$GCreateUserVars extends GCreateUserVars {
  @override
  final _i1.GCreateUserInput user;

  factory _$GCreateUserVars([void Function(GCreateUserVarsBuilder)? updates]) =>
      (new GCreateUserVarsBuilder()..update(updates)).build();

  _$GCreateUserVars._({required this.user}) : super._() {
    BuiltValueNullFieldError.checkNotNull(user, 'GCreateUserVars', 'user');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is GCreateUserVars && user == other.user;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GCreateUserVars')..add('user', user))
        .toString();
  }
}
...
class GCreateUserVarsBuilder
  ...
  _i1.GCreateUserInputBuilder? _user;
  _i1.GCreateUserInputBuilder get user =>
      _$this._user ??= new _i1.GCreateUserInputBuilder();
  set user(_i1.GCreateUserInputBuilder? user) => _$this._user = user;
  ...
  _$GCreateUserVars build() {
    ...
    try {
      _$result = _$v ?? new _$GCreateUserVars._(user: user.build());
    } catch (_) {
